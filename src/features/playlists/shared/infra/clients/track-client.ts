...
import type { ITrack, ITrackClient, ITrackClientPayload } from "../../domain";

export class TrackClient implements ITrackClient {
	...
	async getRecommendations(
		...
		const playlistsRecommendations: ITrackClientPayload["GetRecommendationsOut"]["playlists"] =
			[];

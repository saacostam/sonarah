...
import { AutoHeightPresence, QueryError } from "@/shared/components";
import {
	ChevronDownIcon,
	ChevronLeftIcon,
	ChevronRightIcon,
...
export function PlaylistSearchItem({
	...
	return (
		<Card>
			...
			<AutoHeightPresence isOpen={isExpanded} style={{ marginTop: "1rem" }}>
				<Card>
							...
							<Flex align="center" direction="row" justify="between" mb="3">
								...
								<Tooltip content="Next">
									<Button
										disabled={
											page >=
											Math.ceil(playlistById.data.playlist.tracks.length / 5)
										}
										onClick={() => setPage((p) => p + 1)}
										radius="full"
										size="1"
